    ...
    <div class="container py-4 py-md-5">
                ...
                <div class="d-flex flex-column flex-md-row align-items-center gap-4 position-relative"
                    ...
                    <div class="position-relative">
                        <img src="{{ $user->foto }}" alt="{{ $user->name }}"
                            ...
                            style="width: 96px; height: 96px; aspect-ratio: 1/1;" id="painelHeaderAvatar"
                            onerror="this.onerror=null;this.src='{{ $user->foto_padrao }}';">
                    </div>
                ...
                <ul class="nav nav-tabs border-0 px-3 px-md-4" id="painelTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            id="pedidos-tab" data-bs-toggle="tab" data-bs-target="#pedidos" type="button"
                            role="tab">
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            id="favoritos-tab" data-bs-toggle="tab" data-bs-target="#favoritos" type="button"
                            role="tab">
                            <i class="bi bi-heart me-1"></i> Meus Favoritos
                            @if (isset($favoritos) && $favoritos->count() > 0)
                                <span
                                    class="badge bg-danger-subtle text-danger rounded-pill ms-1">{{ $favoritos->count() }}</span>
                            @endif
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            id="cartoes-tab" data-bs-toggle="tab" data-bs-target="#cartoes" type="button"
                            role="tab">
                            <i class="bi bi-credit-card-2-front me-1"></i> Meus Cartões
                            @if (isset($cartoesSalvos) && $cartoesSalvos->count() > 0)
                                <span
                                    class="badge bg-secondary-subtle text-secondary rounded-pill ms-1">{{ $cartoesSalvos->count() }}</span>
                            @endif
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            id="perfil-tab" data-bs-toggle="tab" data-bs-target="#perfil" type="button"
                            role="tab">
        ...
        <div class="tab-content" id="painelTabContent">
                                ...
                                @if ($user->isAdmin())
                                    ...
                                    @if ($user->podeGerenciarAdministradores())
                                        <a href="{{ route('admin.administradores.index') }}"
                                            class="btn btn-outline-secondary d-flex align-items-center justify-content-between rounded-3 py-2 px-3">
                                            <span><i class="bi bi-shield-lock me-2"></i> Gestão de
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-start gap-3 p-3 bg-light rounded-4">
                                ...
                                <div class="flex-grow-1">
                                    <input type="file" name="foto_perfil" id="foto_perfil"
                                        ...
                                        data-preview-target="avatarPreviewForm">
                ...
                <div class="card border-0 shadow-sm rounded-4 bg-white p-4 p-md-5 mb-4">
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0">Acompanhe seus pedidos, status de envio, rastreamento e
                                avaliações.</p>
                        </div>
                    ...
                    @if ($pedidos->isEmpty())
                        <div class="text-center py-5 bg-light rounded-4">
                            ...
                            <p class="text-muted small mb-3">Quando você finalizar compras, elas aparecerão aqui
                                detalhadamente.</p>
                                ...
                                <tbody>
                                    @foreach ($pedidos as $ped)
                                        <tr>
                                            <td class="ps-3">
                                                <span
                                                    class="fw-bold font-monospace text-primary">{{ $ped->numero_pedido }}</span>
                                            </td>
                                            <td>
                                                <span
                                                    class="small text-muted">{{ $ped->data_pedido?->format('d/m/Y') }}</span>
                                            </td>
                                            <td>
                                                <span
                                                    class="small text-dark">{{ $ped->itens->sum('quantidade_itens') }}
                                                    livro(s)</span>
                                            </td>
                                            <td>
            ...
            <!-- ========================================================
                 ABA: MEUS FAVORITOS
                 ======================================================== -->
            <div class="tab-pane fade {{ $tab === 'favoritos' ? 'show active' : '' }}" id="favoritos"
                role="tabpanel">
                <div class="card border-0 shadow-sm rounded-4 bg-white p-4 p-md-5 mb-4">
                    <div
                        class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-3 mb-4">
                    ...
                    @if ($favoritos->isEmpty())
                        <div class="text-center py-5 bg-light rounded-4">
                            ...
                            <p class="text-muted small mb-3">Ao navegar pelo catálogo, clique no coração para salvar
                                seus títulos preferidos.</p>
                            <a href="{{ url('/#catalogo') }}" class="btn btn-primary btn-sm rounded-pill px-4">
                                Ver Livros
                            </a>
                        </div>
                            ...
                            @foreach ($favoritos as $fav)
                                @if ($fav->livro)
                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                        <div
                                            class="card h-100 border-light-subtle rounded-4 p-3 shadow-xs d-flex flex-column justify-content-between position-relative">
                                            <div>
                                                <div class="position-relative mb-2 text-center">
                                                    <a href="{{ route('livros.detalhes', $fav->livro) }}">
                                                        <img src="{{ $fav->livro->url_capa }}"
                                                            alt="{{ $fav->livro->titulo }}"
                                                            class="rounded-3 object-fit-cover shadow-sm"
                                                            style="width: 100px; height: 140px;">
                                                    </a>
                                                    <form action="{{ route('favoritos.remover', $fav->livro) }}"
                                                        method="POST" class="position-absolute top-0 end-0">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="btn btn-light btn-sm rounded-circle p-1 shadow-sm text-danger"
                                                ...
                                                <p class="text-muted small mb-2 text-truncate">
                                                    {{ $fav->livro->autor?->nome }}</p>
                                                <div class="fw-bold text-primary mb-3">
                                                    {{ $fav->livro->preco_formatado }}</div>
                                            </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 bg-white p-4 p-md-5">
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0">Gerencie seus endereços residenciais e comerciais com
                                carregamento dinâmico via CEP.</p>
                        </div>
                        <button type="button" class="btn btn-primary rounded-pill px-4 shadow-sm fw-semibold"
                            data-bs-toggle="modal" data-bs-target="#modalNovoEndereco">
                    ...
                    @if ($enderecos->isEmpty())
                        <div class="text-center py-5 bg-light rounded-4">
                            ...
                            <p class="text-muted small mb-3">Adicione seus endereços para agilizar o fechamento de
                                pedidos.</p>
                    ...
                    @else
                        <div class="row g-3">
                            @foreach ($enderecos as $end)
                                <div class="col-12 col-md-6">
                                    <div
                                        class="card h-100 border {{ $end->principal ? 'border-primary border-2 shadow-sm bg-primary bg-opacity-10' : 'border-light-subtle shadow-xs' }} rounded-4 p-4 position-relative">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <span
                                                    class="badge {{ $end->tipo === 'comercial' ? 'bg-info-subtle text-info-emphasis border border-info-subtle' : 'bg-primary-subtle text-primary border border-primary-subtle' }} rounded-pill text-capitalize px-3 py-1 fw-semibold">
                                                    <i
                                                        class="bi {{ $end->tipo === 'comercial' ? 'bi-building' : 'bi-house-door' }} me-1"></i>
                                                ...
                                                <ul
                                                    ...
                                                    <li>
                                                        <button type="button" class="dropdown-item small py-2"
                                                            ...
                                                            data-bs-target="#modalEditarEndereco" data-editar-endereco
                                                    ...
                                                    @if (!$end->principal)
                                                        <li>
                                                            <form
                                                                action="{{ route('enderecos.definir-principal', $end) }}"
                                                                method="POST">
                                                                @csrf
                                                                <button type="submit"
                                                    ...
                                                    @endif
                                                    <li>
                                                        <form action="{{ route('enderecos.deletar', $end) }}"
                                                            method="POST"
                                                            data-confirm="Tem certeza que deseja remover este endereço?">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="dropdown-item small py-2 text-danger">
                                        ...
                                        <div
                                            ...
                                            <div class="actions-group">
                                                <button type="button" class="btn-action btn-action-edit"
                                                    ...
                                                    data-editar-endereco data-endereco-id="{{ $end->id }}"
                                                    data-endereco-tipo="{{ $end->tipo }}"
                                                    data-endereco-cep="{{ $end->cep }}"
                                                    data-endereco-rua="{{ $end->rua }}"
                                                    data-endereco-numero="{{ $end->numero }}"
                                                ...
                                                <form action="{{ route('enderecos.deletar', $end) }}" method="POST"
                                                    class="d-inline"
                                                    data-confirm="Tem certeza que deseja remover este endereço?">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn-action btn-action-delete"
                                                        title="Excluir Endereço" aria-label="Excluir">
                                            ...
                                            @if (!$end->principal)
                                                <form action="{{ route('enderecos.definir-principal', $end) }}"
                                                    method="POST">
                                                    @csrf
                                                    <button type="submit"
                                                        class="btn btn-link text-decoration-none btn-sm text-secondary p-0 fw-semibold">
                                                        Definir principal
                                                    </button>
                                                </form>
                                            @endif
            ...
            <!-- ========================================================
                 ...
                 ======================================================== -->
            <div class="tab-pane fade {{ $tab === 'cartoes' ? 'show active' : '' }}" id="cartoes"
                role="tabpanel">
                <div class="card border-0 shadow-sm rounded-4 bg-white p-4 p-md-5">
                    <div
                        class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-3 mb-4">
                        <div>
                            ...
                            <p class="text-muted small mb-0">Gerencie com segurança seus cartões para pagamento rápido
                                em 1 clique.</p>
                        </div>
                        <button type="button" class="btn btn-primary rounded-pill px-4 shadow-sm fw-semibold"
                    ...
                    @if ($cartoesSalvos->isEmpty())
                        <div class="text-center py-5 bg-light rounded-4">
                            ...
                            <p class="text-muted small mb-3">Cadastre um cartão para agilizar suas próximas compras de
                                livros.</p>
                            <button type="button" class="btn btn-outline-primary btn-sm rounded-pill px-4"
                                data-bs-toggle="modal" data-bs-target="#modalNovoCartao">
                                Cadastrar Cartão
                        ...
                        <div class="row g-3">
                            @foreach ($cartoesSalvos as $cartao)
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div
                                        class="card h-100 border {{ $cartao->cartao_padrao ? 'border-primary border-2 shadow-sm bg-primary bg-opacity-10' : 'border-light-subtle shadow-xs' }} rounded-4 p-4 d-flex flex-column justify-content-between">
                                        <div>
                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <span
                                                    class="badge bg-dark-subtle text-dark border rounded-pill px-3 py-1 text-uppercase fw-bold font-monospace">
                                                    <i class="bi bi-credit-card me-1"></i>
                                                    {{ $cartao->bandeira_cartao }}
                                                </span>
                                            ...
                                            <p class="small text-muted mb-0">Adicionado em
                                                {{ $cartao->created_at?->format('d/m/Y') }}</p>
                                        </div>

                                        <div
                                            class="mt-4 pt-2 border-top d-flex justify-content-between align-items-center">
                                            @if (!$cartao->cartao_padrao)
                                                <form action="{{ route('cartoes.definir-padrao', $cartao) }}"
                                                    method="POST">
                                                    @csrf
                                                    <button type="submit"
                                                        class="btn btn-link text-decoration-none btn-sm text-primary p-0 fw-semibold">
                                                        Definir padrão
                                                    </button>
                                                </form>
                                            @else
                                            ...
                                            <form action="{{ route('cartoes.deletar', $cartao) }}" method="POST"
                                                ...
                                                @method('DELETE')
                                                <button type="submit" class="btn-action btn-action-delete"
                                                    title="Excluir Cartão" aria-label="Excluir Cartão">
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </form>
                                        </div>
                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-12 col-md-6">
                                <button type="submit" class="btn btn-danger rounded-pill px-4 py-2 fw-semibold"
                                    data-confirm="Tem certeza absoluta que deseja excluir permanentemente sua conta?">
                            ...
                            <div class="col-12 mt-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="principal" value="1"
                                        id="switchPrincipal" {{ $enderecos->isEmpty() ? 'checked' : '' }}>
            ...
            <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
                <div class="modal-header bg-primary text-white p-4">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="modal-title fw-bold mb-0" id="modalEditarEnderecoLabel">Editar Endereço de Entrega
                        </h5>
                    </div>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Fechar"></button>
            ...
            <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
                <div class="modal-header bg-primary text-white p-4">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="modal-title fw-bold mb-0" id="modalNovoCartaoLabel">Adicionar Cartão de Crédito
                        </h5>
                    </div>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Fechar"></button>
                ...
                <form action="{{ route('cartoes.salvar') }}" method="POST">
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label class="form-label small fw-bold text-secondary">Nome Impresso no Cartão
                                    *</label>
                                <input type="text" name="nome_titular"
                                    class="form-control rounded-3 text-uppercase" placeholder="NOME COMO NO CARTÃO"
                                    required>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="p-2 bg-light rounded-3 text-muted small d-flex align-items-center gap-2">
                                    ...
                                    <span>Seus dados são criptografados de ponta a ponta e tokenizados com
                                        segurança.</span>
                                </div>
                            </div>
                        </div>

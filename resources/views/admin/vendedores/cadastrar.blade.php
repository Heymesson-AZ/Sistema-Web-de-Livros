                    ...
                    <form method="POST" action="{{ route('admin.vendedores.store') }}">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Nome do representante legal" required>
                                @error('name')
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="contato@empresa.com" required>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label small fw-bold text-secondary">Senha de Acesso <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label small fw-bold text-secondary">Confirmar Senha <span class="text-danger">*</span></label>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="nome_fantasia" class="form-control @error('nome_fantasia') is-invalid @enderror" value="{{ old('nome_fantasia') }}" placeholder="Ex: Livraria Estrela Guia" required>
                                @error('nome_fantasia')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="razao_social" class="form-control @error('razao_social') is-invalid @enderror" value="{{ old('razao_social') }}" placeholder="Ex: Estrela Guia Livros Ltda" required>
                                @error('razao_social')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="cnpj" class="form-control @error('cnpj') is-invalid @enderror" value="{{ old('cnpj') }}" placeholder="00.000.000/0000-00" required>
                                @error('cnpj')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="inscricao_estadual" class="form-control @error('inscricao_estadual') is-invalid @enderror" value="{{ old('inscricao_estadual') }}" placeholder="Ex: 123.456.789.000 ou ISENTO" required>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="telefone_comercial" class="form-control @error('telefone_comercial') is-invalid @enderror" value="{{ old('telefone_comercial') }}" placeholder="(00) 00000-0000">
                        ...
                        <h5 class="fw-bold text-dark mb-3 d-flex align-items-center gap-2">
                            ...
                            Status Inicial do Vendedor
                        </h5>

                        <div class="row g-3 mb-4">
                            <div class="col-12 col-md-6">
                                <label class="form-label small fw-bold text-secondary">Status de Aprovação <span class="text-danger">*</span></label>
                                <select name="status_aprovacao" class="form-select @error('status_aprovacao') is-invalid @enderror" required>
                                    <option value="aprovado" {{ old('status_aprovacao', 'aprovado') === 'aprovado' ? 'selected' : '' }}>Aprovado (Permite publicar e vender)</option>
                                    <option value="pendente" {{ old('status_aprovacao') === 'pendente' ? 'selected' : '' }}>Pendente (Aguardando análise)</option>
                                    <option value="rejeitado" {{ old('status_aprovacao') === 'rejeitado' ? 'selected' : '' }}>Rejeitado (Bloqueado)</option>
                                </select>

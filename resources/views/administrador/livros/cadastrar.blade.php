    ...
    <div class="container py-4">
        ...
        <nav aria-label="breadcrumb" class="mb-3">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active text-primary fw-semibold" aria-current="page">Novo Livro</li>
            </ol>
        </nav>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">
                    Adicione uma nova obra literária ao catálogo oficial da plataforma.
                </p>
            </div>
                        ...
                        <form method="POST" action="{{ route('admin.livros.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <input type="file" name="capa" id="capaInput"
                                        ...
                                        onchange="window.previewImage(this, 'capaPreview')">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-12 col-md-8">
                                    ...
                                    <input type="text" name="titulo"
                                        ...
                                        value="{{ old('titulo') }}" placeholder="Ex: Dom Casmurro" required>
                                    @error('titulo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="sinopse" rows="5" class="form-control @error('sinopse') is-invalid @enderror"
                                    placeholder="Resumo envolvente sobre o enredo ou conteúdo do livro...">{{ old('sinopse') }}</textarea>
                                @error('sinopse')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                                ...
                                <button type="submit"
                                    ...
                                    <i class="bi bi-check-lg me-1"></i> Cadastrar Livro
                                </button>
                            </div>

...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('livros', function (Blueprint $table) {
            ...
            $table->unsignedInteger('quantidade')->default(0); // Quantidade em estoque, valor padrão 0
             // Definindo a chave estrangeira para 'autor_id'
            $table->foreignId('autor_id')->constrained('autores')->onDelete('cascade');
            $table->foreignId('genero_id')->constrained('generos')->onDelete('cascade'); // Chave estrangeira referenciando o gênero do livro
            $table->foreignId('editora_id')->constrained('editoras')->onDelete('cascade'); // Chave estrangeira referenciando a editora do livro
  ...
  /**
    ...
    {
        // Removendo a tabela 'livros' caso a migration seja revertida

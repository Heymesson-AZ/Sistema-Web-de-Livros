<x-layouts.principal>
    <div class="container py-4">
        ...
        <div
            ...
            <div>
                <h1 class="h3 fw-bold text-dark mb-1">
                    ...
                    Ficha Cadastral do Livro
                </h1>
                <p class="text-muted small mb-0">
                    Detalhes administrativos, estoque e métricas de desempenho da obra.
                </p>
            </div>
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="{{ route('admin.livros.edit', $livro) }}" class="btn btn-primary rounded-3">
                    <i class="bi bi-pencil me-1"></i> Editar Livro
                </a>
                <a href="{{ route('admin.livros.index') }}" class="btn btn-light border rounded-3">
        ...
        <div class="row g-4">
            ...
            <!-- COLUNA ESQUERDA: CAPA & RESUMO FINANCEIRO -->
            <div class="col-12 col-md-4">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                    ...
                    <div class="card-body p-4 text-center">
                        ...
                        <span class="text-muted small">Preço de Venda Unitário</span>
                        ...
                        <div class="mt-3 pt-3 border-top">
                            @if ($livro->isDisponivel())
                                <span
                                    ...
                                    <i class="bi bi-check-circle-fill me-1"></i> {{ $livro->quantidade }} em estoque
                                </span>
                            @else
                                <span
                                    class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-25 rounded-pill px-3 py-2 fs-6">
                                    <i class="bi bi-exclamation-circle-fill me-1"></i> Esgotado
                                </span>
                            @endif
                        </div>
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <div class="card border-0 shadow-sm rounded-4 p-3 text-center bg-white">
                            <span class="text-muted small text-uppercase fw-semibold">Receita</span>
            ...
            <!-- COLUNA DIREITA: DADOS TÉCNICOS & RELACIONAMENTOS -->
            <div class="col-12 col-md-8">
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12">
                            <label class="small text-muted fw-semibold d-block">Título Completo</label>
                        ...
                        <div class="col-6 col-sm-4">
                            <label class="small text-muted fw-semibold d-block">Cadastrado em</label>
                            <span
                                class="text-dark">{{ $livro->created_at ? $livro->created_at->format('d/m/Y H:i') : '-' }}</span>
                        </div>
                    </div>

                    <h5 class="fw-bold text-dark mb-3 border-bottom pb-2">Relacionamentos</h5>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12 col-sm-6">
                            <div class="p-3 bg-light rounded-3">
                                ...
                                @if ($livro->autor?->nacionalidade)
                                    <div class="small text-muted">{{ $livro->autor->nacionalidade }}</div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="p-3 bg-light rounded-3">
                                <span class="small text-muted fw-semibold d-block mb-1">Vendedor / Loja</span>
                                <strong
                                    class="text-dark">{{ $livro->vendedor->nome_fantasia ?? ($livro->vendedor->razao_social ?? 'Não informado') }}</strong>
                                <div class="small text-muted">{{ $livro->vendedor->user->email ?? '' }}</div>
                            </div>
                        </div>
                    </div>

                    <h5 class="fw-bold text-dark mb-3 border-bottom pb-2">Sinopse</h5>

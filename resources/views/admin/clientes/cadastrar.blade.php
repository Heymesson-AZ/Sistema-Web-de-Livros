                    ...
                    <form method="POST" action="{{ route('admin.clientes.store') }}">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Nome do cliente" required>
                                @error('name')
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="cliente@email.com" required>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="celular_contato" class="form-control @error('celular_contato') is-invalid @enderror" value="{{ old('celular_contato') }}" placeholder="(00) 00000-0000">

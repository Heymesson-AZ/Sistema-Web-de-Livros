                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
                    ...
                    <form action="{{ route('admin.cupons.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text" style="font-size: 11px;">Será salvo em letras maiúsculas automaticamente.</div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-12 col-md-6">
                                ...
                                <select name="tipo_desconto" class="form-select" required>
                                    ...
                                    <option value="valor_fixo" {{ old('tipo_desconto') === 'valor_fixo' ? 'selected' : '' }}>Valor Fixo (R$)</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-6">

            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted mx-auto" style="max-width: 540px;">
                        Abra sua livraria ou sebo online e alcance leitores em todo o país. Preencha os dados abaixo e
                        envie sua solicitação para avaliação.
                    </p>
                </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="{{ route('vendedor.solicitar.salvar') }}">
                            ...
                            @auth
                                <div
                                    class="alert alert-primary bg-primary bg-opacity-10 border-0 rounded-3 p-3 mb-4 d-flex align-items-center gap-3">
                                    ...
                                    <div class="small">
                                        ...
                                        <div class="text-muted">{{ Auth::user()->email }} — Sua conta atual será vinculada a
                                            este perfil de vendedor comercial.</div>
                                    </div>
                                </div>
                            @else
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label for="email" class="form-label small fw-bold text-secondary">E-mail de
                                            Acesso *</label>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="password" class="form-control" id="password_confirmation"
                                            name="password_confirmation" placeholder="Repita sua senha" required>
                                    </div>
                                </div>
                            @endauth
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="razao_social" class="form-label small fw-bold text-secondary">Razão
                                        Social *</label>
                                    <input type="text"
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="cnpj" class="form-label small fw-bold text-secondary">CNPJ
                                        *</label>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('telefone_comercial') }}" data-mask="telefone"
                                ...
                                <div class="col-12">
                                    <label for="inscricao_estadual"
                                        class="form-label small fw-bold text-secondary">Inscrição Estadual
                                        (Opcional)</label>
                                    <input type="text"
                            ...
                            <div class="card bg-light border-0 rounded-3 p-3 mb-4">
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div class="small text-muted">
                                        <strong class="text-dark d-block mb-1">Como funciona o processo de
                                            aprovação?</strong>
                                        Após enviar sua solicitação, nossa equipe administrativa revisará as informações
                                        comerciais em até <strong>24 a 48 horas úteis</strong>. Enquanto sua conta
                                        estiver com o status <em>Pendente</em>, você poderá acessar o painel para
                                        acompanhar o status e atualizar seus dados.
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- BOTÕES DE SUBMISSÃO -->
                            <div
                                class="d-flex flex-column flex-sm-row align-items-center justify-content-between gap-3 pt-3 border-top">
                                <a href="{{ url('/') }}"
                                    class="btn btn-light rounded-3 px-4 text-muted w-100 w-sm-auto">
                                    <i class="bi bi-arrow-left me-1"></i> Voltar ao Início
                                </a>
                                <button type="submit"
                                    class="btn btn-primary rounded-3 px-4 py-2 fw-semibold w-100 w-sm-auto shadow-sm">

                ...
                <div class="col-12 col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" name="busca" class="form-control border-start-0 ps-0"
                            placeholder="Buscar por nome, e-mail ou telefone..." value="{{ request('busca') }}">
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3">
                    <select name="departamento" class="form-select">
                        ...
                        @foreach ($departamentos as $dep)
                            <option value="{{ $dep }}"
                                {{ request('departamento') === $dep ? 'selected' : '' }}>{{ $dep }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-6 col-md-2">
                    <select name="cargo" class="form-select">
                        ...
                        @foreach ($cargos as $cg)
                            <option value="{{ $cg }}" {{ request('cargo') === $cg ? 'selected' : '' }}>
                                {{ $cg }}</option>
                        @endforeach
                    </select>
                </div>
                                            ...
                                            <div class="fw-bold text-dark d-flex align-items-center gap-2">
                                                ...
                                                @if (Auth::id() === $admin->user_id)
                                                    <span
                                                        ...
                                                        style="font-size: 10px;">Você</span>
                                                @endif
                                            </div>
                                ...
                                <td class="py-3">
                                    @php
                                        $badgeClass = match ($admin->cargo) {
                                            \App\Models\Admin::CARGO_SUPER_ADMIN
                                                => 'bg-purple-subtle text-purple border-purple-subtle',
                                            \App\Models\Admin::CARGO_GERENTE_CATALOGO,
                                            \App\Models\Admin::CARGO_GERENTE_COMERCIAL
                                                => 'bg-info-subtle text-info-emphasis border-info-subtle',
                                            default => 'bg-secondary-subtle text-secondary border-secondary-subtle',
                                        };
                                    @endphp
                                    <span class="badge {{ $badgeClass }} border px-2 py-1 rounded-pill"

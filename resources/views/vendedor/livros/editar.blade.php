        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">
                    Modifique as informações de <strong>"{{ $livro->titulo }}"</strong> na sua loja.
                </p>
            </div>
            ...
            <div class="col-12 col-lg-10">
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="{{ route('vendedor.livros.update', $livro) }}"
                            ...
                            <div class="row mb-4 align-items-center">
                                <div class="col-12 col-sm-auto text-center mb-3 mb-sm-0">
                                    <div class="bg-light p-2 rounded-3 border d-inline-flex align-items-center justify-content-center"
                                        ...
                                        <img src="{{ $livro->url_capa }}" id="capaPreviewEditVendedor"
                                            alt="Prévia da Capa" class="rounded shadow-sm"
                                ...
                                <div class="col">
                                    ...
                                    <input type="file" name="capa" id="capaInputEdit"
                                        ...
                                        onchange="window.previewImage(this, 'capaPreviewEditVendedor')">
